...
Если телефония не работает в целом, а не только из-за лицензии (нет прав, не настроены персональные параметры, недоступна АТС, не захватывается фича) — воспользуйтесь общей инструкцией [«Анализ проблем лицензирования»](/faq/licensing-troubleshooting/).
