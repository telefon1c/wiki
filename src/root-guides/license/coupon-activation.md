...
2. Откроется форма со списком продуктов, присутствующих в лицензионном ключе.
...
3. Внизу формы в поле **Активация купона** вставьте купон и нажмите кнопку **Активировать**.
