...
Предварительно необходимо установить и настроить веб-сервер Apache или IIS (подробные инструкции можно найти [на портале 1C:ИТС](https://its.1c.ru/db/v8312doc#bookmark:adm:TI000000194).  
Мы используем [инструкцию с инфостарта](https://infostart.ru/public/646384/).  
О настройке защищенного соединения можно прочитать [здесь](https://its.1c.ru/db/metod8dev/content/5978/hdoc).  
